...
abstract class UnityWidgetPlatform extends PlatformInterface {
  ...
  UnityWidgetPlatform() : super(token: token);
  ...
  Future<void> galleryProfileDidLoad({
    ...
    throw UnimplementedError(
      'galleryProfileDidLoad() has not been implemented.',
    );
  }
  ...
  Future<void> sneakersDidLoad({
    ...
    throw UnimplementedError(
      'sneakersDidLoad() has not been implemented.',
    );
  }
  ...
  Stream<UnityGalleryStateChangeEvent> onUnityGalleryStateChange({
    ...
    throw UnimplementedError(
      'onUnityGalleryStateChange() has not been implemented.',
    );
  }
